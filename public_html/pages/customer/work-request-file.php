...
if ($file === null || !customer_can_view_connection_request_file($file) || !is_file((string) $file['storage_path'])) {
    http_response_code(404);
    exit('A fájl nem található.');
}

header('Content-Type: ' . $file['mime_type']);
header('Content-Length: ' . (string) filesize((string) $file['storage_path']));
