...
if (is_post()) {
    ...
    if ($errors === []) {
        try {
            ...
            redirect('/admin/work-request-view?request=' . (int) $request['id']);
...
<section class="admin-section">
    <div class="container">
        <div class="admin-header">
            ...
            <a class="button button-secondary" href="<?= h(url_path('/admin/work-request-view') . '?request=' . (int) $request['id']); ?>">Vissza a munkához</a>
        </div>
